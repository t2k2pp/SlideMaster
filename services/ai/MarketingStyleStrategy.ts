...
Create a visually striking and engaging image that accurately represents the specific slide content while applying only the specified visual touch style.`;
  }
